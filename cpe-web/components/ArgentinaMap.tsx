    ...
    >
      ...
      <g className="ar-country" filter="url(#softShadow)">
        <path
          ...
          className="cc-country cc-stroke"
          strokeWidth="1.5"
      ...
      <g transform="translate(40, 120)" className="ar-legend">
        ...
        <g transform="translate(0, 20)">
          <rect width="12" height="12" rx="2" className="cc-amber" />
          <text x="22" y="10" className="ar-legend-text">Neuquina Norte</text>
        </g>
        <g transform="translate(0, 40)">
          <rect width="12" height="12" rx="2" className="cc-green-light" />
          <text x="22" y="10" className="ar-legend-text">Cuyana</text>
        </g>
        <g transform="translate(0, 60)">
          <rect width="12" height="12" rx="2" className="cc-green" />
          <text x="22" y="10" className="ar-legend-text">Neuquina / San Jorge N.</text>
        </g>
        <g transform="translate(0, 80)">
          <rect width="12" height="12" rx="2" className="cc-teal" />
          <text x="22" y="10" className="ar-legend-text">Golfo San Jorge S.</text>
        </g>
        <g transform="translate(0, 100)">
          <rect width="12" height="12" rx="2" className="cc-teal-dark" />
          <text x="22" y="10" className="ar-legend-text">Cuenca Austral</text>
        </g>
      </g>
    </svg>
  )
