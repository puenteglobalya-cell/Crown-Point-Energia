...
export const ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    helpText: 'precio = (referencia + descuento fijo) × (1 − DDE%) / divisor + extra − tarifa de almacenamiento (USD/m3/día × días, convertido a USD/bbl). DDE% es fijo (campo "DDE %") salvo que completes los 4 campos de tramo por Brent — ahí se calcula solo, lineal entre el mínimo y el máximo, y el campo "DDE %" fijo se ignora. El divisor suele ser 1 − alícuota IIBB (ej. 0.97 si IIBB es 3%).',
    fields: [
      { name: 'yacimiento_id', label: 'Yacimiento', type: 'select', optionsFrom: 'yacimientos', required: true },
